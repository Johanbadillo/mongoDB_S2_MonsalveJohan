...
// Listar productos con más de 3 comentarios y cuyo precio supere $100
db.productos.aggregate([
  {
    $match: {
      precio: { $gt: 100 }
...
// Buscar productos con nombre que comience con letra "A" o "P" usando REGEX

// En "^[AP]"  el ^ antes de las llaves significa que la busqueda se hacen con el parametro de adentro de las llaves [], debe empezar con esa la palabra o frase
...
// Agrupar por categoría y obtener: cantidad, promedio de precio, y stock máximo
...
// Filtrar productos que tengan al menos un comentario con la palabra “recomendado” o “perfecto”
...
// Mostrar los 5 usuarios con más comentarios hechos
